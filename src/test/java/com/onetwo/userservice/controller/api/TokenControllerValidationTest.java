...
public class TokenControllerValidationTest {
    ...
    void reissueAccessTokenAccessTokenValidationFailTest(String accessToken) throws Exception {
        ...
        ReissueTokenDto reissueTokenDto = new ReissueTokenDto(accessToken, refreshToken);

        ReissuedTokenDto reissuedTokenDto = new ReissuedTokenDto(accessToken);

        when(userTokenService.reissueAccessTokenByRefreshToken(reissueTokenDto)).thenReturn(reissuedTokenDto);
        //when
